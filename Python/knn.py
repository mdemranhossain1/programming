...
# Impute zeros with mean of non-zero values for specific columns
def impute_zeros_with_mean(dataset, columns):
    for col in columns:
        non_zero_vals = [row[col] for row in dataset if row[col] != 0]
...
filename = 'your_dataset.csv'  # Put your CSV filename here
